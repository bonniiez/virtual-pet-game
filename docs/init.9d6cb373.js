...
const DAY_LENGTH = 2500;
exports.DAY_LENGTH = DAY_LENGTH;
const NIGHT_LENGTH = 1000;
exports.NIGHT_LENGTH = NIGHT_LENGTH;

const getNextHungerTime = clock => Math.floor(Math.random() * 3) + 700 + clock;

exports.getNextHungerTime = getNextHungerTime;

const getNextDieTime = clock => Math.floor(Math.random() * 3) + 1000 + clock;

exports.getNextDieTime = getNextDieTime;

const getNextPoopTime = clock => Math.floor(Math.random() * 3) + 700 + clock;
...
exports.printTimer = exports.writeModal = exports.togglePoopBag = exports.modScene = exports.modFox = void 0;
...
const printTimer = function printTimer(timer) {
  document.querySelector(".timer").innerHTML = `<div class="timer-inner"> Time fox is kept alive: ${timer} seconds</div>`;
};
...
const gameState = {
  ...
  tick() {
    ...
    if (this.startTimerCount === "START_TIMER") {
      this.timer++;
      (0, _ui.printTimer)(Math.floor(this.timer / 60));
  ...
  handleUserAction(icon) {
    if (["FEEDING", "SLEEP", "CELEBRATING", "HATCHING"].includes(this.current)) {
      return;
    }
  ...
  poop() {
    ...
    (0, _ui.writeModal)("Oh no! The fox pooped. Help clean it!");
  },
  ...
  getHungry() {
    ...
    this.hungryTime = -1;
    (0, _ui.modFox)("hungry");
    (0, _ui.writeModal)("oh! The fox is hungry.. maybe you should feed him.");
  },
...
init();
},{"./gameState":"gameState.js","./constants":"constants.js","./button":"button.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","init.js"], null)
